          ...
          <div className={styles.cardActions}>
            {showModelsButton && (
              <Button
                ...
                title={t('auth_files.models_button', { defaultValue: 'Modelos' })}
            ...
            {!isRuntimeOnly && (
              <>
                <Button
                  ...
                  className={styles.iconButton}
                  title={t('common.info', { defaultValue: 'Información' })}
                  disabled={disableControls}
                >
            ...
            {isRuntimeOnly && (
              <div className={styles.virtualBadge}>
                {t('auth_files.type_virtual') || 'Archivo de autenticación virtual'}
              </div>
            )}
          </div>
        </div>
